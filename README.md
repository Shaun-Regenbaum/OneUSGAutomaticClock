...
Otherwise, simply clone the repo, fill out the details and how many hours you want to clock in the script (*clock_manager.py*) and run the file and it'll work!
